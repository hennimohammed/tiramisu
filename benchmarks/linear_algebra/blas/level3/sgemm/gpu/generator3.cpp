...
int main(int argc, char **argv)
{
    ...
    buffer b_A_copy_reg("b_A_copy_reg", {R_BLOCK_I}, DATA_PTYPE, a_temporary);
    buffer b_B_copy_reg("b_B_copy_reg", {R_BLOCK_J}, DATA_PTYPE, a_temporary);
    ...
    b_A_copy_reg.tag_gpu_local();
    b_B_copy_reg.tag_gpu_local();
    b_acc.tag_gpu_local();
    ...
    computation c_A_glb_to_reg({i0, j0, k0, i1}, c_A_glb(i0, j0, k0 + 1, i1));
    computation c_A_reg_to_shr({i0, j0, k0, i1}, c_A_copy_reg(i1));
    ...
    computation c_B_glb_to_reg({i0, j0, k0, j1}, c_B_glb(i0, j0, k0 + 1, j1));
    computation c_B_reg_to_shr({i0, j0, k0, j1}, c_B_copy_reg(j1));
    ...
    computation c_A_copy_reg_dec({i0, j0}, allocate(b_A_copy_reg));
    computation c_B_shr_dec({i0, j0}, allocate(b_B_shr));
    computation c_B_reg_dec({i0, j0}, allocate(b_B_reg));
    computation c_B_copy_reg_dec({i0, j0}, allocate(b_B_copy_reg));
    ...
    computation c_sync3({i0, j0, k0}, tiramisu::sync());
    ...
    c_A_glb_to_reg.add_predicate(k0 != K / BLOCK - 1);
    c_B_glb_to_reg.add_predicate(k0 != K / BLOCK - 1);
    c_A_reg_to_shr.add_predicate(k0 != K / BLOCK - 1);
    c_B_reg_to_shr.add_predicate(k0 != K / BLOCK - 1);

    c_A_shr_dec.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    c_A_reg_dec.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    c_A_copy_reg_dec.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    c_acc_dec.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    c_A_glb_to_shr_pre.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    c_A_glb_to_reg.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    c_A_reg_to_shr.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    ...
    c_B_copy_reg_dec.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    c_B_glb_to_shr_pre.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    c_B_glb_to_reg.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    c_B_reg_to_shr.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    ...
    c_sync3.gpu_tile(i0, j0, BLOCK, BLOCK, i00, j00, i01, j01);
    ...
    copy_A_to_device.then(copy_B_to_device, computation::root)
                    ...
                    .then(c_A_copy_reg_dec, j01)
                    .then(c_B_copy_reg_dec, j01)
                    ...
                    .then(c_sync1, j01)
                    .then(c_A_glb_to_reg, j01)
                    .then(c_B_glb_to_reg, k0)
                    .then(c_B_shr_to_reg, k0)
                    .then(c_A_shr_to_reg, k1)
                    .then(c_acc, i1)
                    .then(c_sync2, k0)
                    .then(c_A_reg_to_shr, k0)
                    .then(c_B_reg_to_shr, k0)
                    .then(c_sync3, k0)
                    .then(c_C, j01)
    ...
    // Note the transpose:
    c_A_glb_to_shr_pre.store_in(&b_A_shr, {i0 % BLOCK, j0 % BLOCK * R_BLOCK_I + i1});
    c_A_glb_to_reg.store_in(&b_A_copy_reg, {i1});
    c_A_reg_to_shr.store_in(&b_A_shr, {i0 % BLOCK, j0 % BLOCK * R_BLOCK_I + i1});
    c_A_copy_reg.store_in(&b_A_copy_reg);
    c_A_shr.store_in(&b_A_shr, {k1, i0 % BLOCK * R_BLOCK_I + i1});
    ...
    c_B_glb_to_shr_pre.store_in(&b_B_shr, {j1, j0 % BLOCK * R_BLOCK_J + i0 % BLOCK});
    c_B_glb_to_reg.store_in(&b_B_copy_reg, {j1});
    c_B_reg_to_shr.store_in(&b_B_shr, {j1, j0 % BLOCK * R_BLOCK_J + i0 % BLOCK});
    c_B_copy_reg.store_in(&b_B_copy_reg);
    c_B_shr.store_in(&b_B_shr, {k1, j0 % BLOCK * R_BLOCK_J + j1});
